...
/**
 * Actualiza cupo, LinkedIn y foto desde la planilla para tutores ya existentes.
...
async function syncExistingTutorFieldsFromSheet() {
  ...
  const pool = getPool();
  const stats = { cuposUpdated: 0, linkedinUpdated: 0, fotosUpdated: 0, profilesUpdated: 0 };
